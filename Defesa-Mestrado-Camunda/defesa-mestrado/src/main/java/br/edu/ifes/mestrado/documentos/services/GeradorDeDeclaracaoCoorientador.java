...
public class GeradorDeDeclaracaoCoorientador extends AbstractDocTextReplacer {
    ...
    public static String gerarDeclaracao(String nomeCoordenador, String coOrientador, String nomeAluno,
        ...
        String templatePath = "/home/davidson/Desktop/Defesa-Mestrado-BPMN/Defesa-Mestrado-Camunda/defesa-mestrado/src/main/java/br/edu/ifes/mestrado/documentos/templates/entrada/Modelo_Declaração_Coorientador.docx";
        String outputPath = "/home/davidson/Desktop/Defesa-Mestrado-BPMN/Defesa-Mestrado-Camunda/defesa-mestrado/src/main/java/br/edu/ifes/mestrado/documentos/templates/saida/declaracao_coorientador/DECLARACAO_COORIENTADOR_" + tituloTese.replaceAll("[^a-zA-Z0-9.-]", "_") + "_" + nomeAluno.replaceAll("[^a-zA-Z0-9.-]", "_") + ".docx";
        ...
        try {
            ...
            fis.close();
            document.close();
            System.out.println("Declaração de Coorientador gerada em: " + outputPath);
