...
public class GeradorDeDeclaracaoMembroInterno extends AbstractDocTextReplacer {
    ...
    public static void gerarDeclaracao(String nomeCoordenador, String membroInterno, String nomeAluno,
        ...
        String outputPath = "C:\\Users\\Davidson\\Desktop\\Defesa-Mestrado-BPMN\\Defesa-Mestrado-Camunda\\defesa-mestrado\\src\\main\\java\\br\\edu\\ifes\\mestrado\\documentos\\templates\\saida\\declaracao_interno\\DECLARACAO_INTERNO_" + nomeAluno.replaceAll("[^a-zA-Z0-9.-]", "_") + ".docx";
