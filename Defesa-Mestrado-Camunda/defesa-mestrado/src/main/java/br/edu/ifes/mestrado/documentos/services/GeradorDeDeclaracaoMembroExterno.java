...
public class GeradorDeDeclaracaoMembroExterno extends AbstractDocTextReplacer {
    ...
    public static void gerarDeclaracao(String nomeCoordenador, String membroExterno, String nomeAluno,
        ...
        String outputPath = "C:\\Users\\Davidson\\Desktop\\Defesa-Mestrado-BPMN\\Defesa-Mestrado-Camunda\\defesa-mestrado\\src\\main\\java\\br\\edu\\ifes\\mestrado\\documentos\\templates\\saida\\declaracao_externa\\DECLARACAO_EXTERNA_" + nomeAluno.replaceAll("[^a-zA-Z0-9.-]", "_") + ".docx";
